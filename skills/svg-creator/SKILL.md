---
name: svg-creator
description: SVG ダイアグラム・アイコン・図解を直接生成するスキル。レクタースタイル（Navy #1B4565 + Teal #3E9BA4）に準拠したベクターグラフィックスを作成する。SVG、図解、ダイアグラム、アイコン、フローチャート、アーキテクチャ図、概念図、プロセス図などのキーワードが含まれる場合は積極的に使用すること。
---
