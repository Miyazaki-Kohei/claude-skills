...
import { ASPECT_RATIOS, ENGINE_MODEL_IDS, FORMAT_MIME, IMAGE_STYLE_PROMPTS, } from "./config.js";
import { createClient, enhancePrompt, generateImage, resolveApiKey, } from "./imagen.js";
const program = new Command();
program
    .name("image-creator")
    .description("Google Imagen 4 image generator")
    .argument("<prompt>", "Image generation theme / prompt")
    .requiredOption("-o, --output <path>", "Output file path")
    .option("-t, --style <style>", `Image style (${Object.keys(IMAGE_STYLE_PROMPTS).join(", ")})`, "flat")
    .option("-a, --aspect-ratio <ratio>", `Aspect ratio (${ASPECT_RATIOS.join(", ")})`, "16:9")
    .option("-e, --engine <engine>", `Imagen engine (${Object.keys(ENGINE_MODEL_IDS).join(", ")})`, "imagen4")
    .option("-f, --format <format>", `Output format (${Object.keys(FORMAT_MIME).join(", ")})`)
